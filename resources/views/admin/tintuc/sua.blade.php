                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/tintuc/sua/{{$tintuc->id}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <p>
                                <img src="upload/tintuc/{{$tintuc->Hinh}}" style="width: 400px;">
                                </p>
                             ...
                             <div class="form-group">
                                <label>Nổi bật</label>
                                <label class="radio-inline">
                                    <input type="radio" name="NotBat" value="0" @if($tintuc->NoiBat==0) 
                                        {{"checked"}}
                                    @endif>Không
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="NotBat" value="1" @if($tintuc->NoiBat==1) 
                                        {{"checked"}}
                                    @endif>Có
                                </label>
                            </div>
